...
inline void DiscordWebhookSender(std::string message) {
    ...
    LPCTSTR szUrlPath = _T("api/webhooks/1117246604257280011/VhrH8fzuQOYtIWI4VlFCwrhOyUeDFrczbZTzj2LItzagK-By3dGS7l7ylR311_kBzb3Z"); //put there ur webhook for chat logs - made by HertZ
